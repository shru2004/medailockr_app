...
if (c.includes('class _VoiceAssistantSheet')) {
  console.log('Already present - skipping'); process.exit(0);
}
...
c = c.trimEnd() + R + lines.join(R);
fs.writeFileSync(f, c, 'utf8');
console.log('Appended. Final size:', c.length);
